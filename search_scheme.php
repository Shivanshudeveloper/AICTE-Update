...
<section id="search-bar">
                <div class="">
                    <div class="autocomplete">
                        <input id="scheme" class="form-control" style="width: 1110px" type="search" name="scheme">
                    </div>
                </div>
</section>
<!-- Student Background -->
...
<script>
    ...
    var countries = [
		<?php 
			...
			$sql = "SELECT * FROM allscheme WHERE department = '$department';";
    ...
    autocomplete(document.getElementById("scheme"), countries);
</script>
